...
console.log('First Second: ' + exampleSecondWord);
console.log('First Third: ' + exampleThirdWord);
console.log('First Fourth: ' + exampleFourthWord);
console.log('First fifth: ' + exampleFifthWord);
